...
from components.SkillComponent import MovementDash, ActiveSkill, MovementTeleportation, CombatTarget, CombatAoe, \
    StatusUnit
from effect_factories import bleed_effect, burn_effect, weaken_effect, stun_effect, curse_effect
...
fireball_aoe = ActiveSkill(
    ...
    cooldown=2,
    time_cost=1.5,
    units=[CombatAoe(is_ranged=True, radius=2, damage=15)]
)
